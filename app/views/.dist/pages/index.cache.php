...
?>
<?php  Capsule::PartialRender ('h3', [], function($args, CapsuleScopeContext $scope){return $scope->users;}); ?>
...
?>
<?php  Capsule::PartialRender ('div', ['data-user-list' => $scope->users], Capsule::CreateElement ('h1', [], function($args, CapsuleScopeContext $scope){return $scope->title;}), Capsule::Yield (null, [])); ?>
<?php }); ?>
...
<?php  Capsule::PartialRender ('ul', [], function ($args, CapsuleScopeContext $scope) {$ref9332182044erence = $scope->data;
	if (isset ($ref9332182044erence) && is_array ($ref9332182044erence)) {
	for ($i = 0; $i < count ($ref9332182044erence); $i++) {
		$ref9332182044 = $ref9332182044erence[$i];
		if (in_array (strtolower(gettype($ref9332182044)), ['array', 'object'])) {
			$ref9332182044 = \Saml::Array2Object($ref9332182044);
			$ref9332182044_props = array_keys ((array)($ref9332182044));
			if (is_object ($ref9332182044) && in_array ('Sammy\Packs\Sami\Base\ILeanable', class_implements (get_class ($ref9332182044)))) {
				$ref9332182044_props = array_keys ((array)($ref9332182044->lean()));
			}
			foreach ($ref9332182044_props as $key) {
				if (is_right_var_name($key)) { $scope->$key = is_object ($ref9332182044) ? $ref9332182044->$key : $ref9332182044[$key]; }
			}
		}

       

 Capsule::PartialRender ('Fragment', [], Capsule::CreateElement ('li', [], 'Nome1 => ', function($args, CapsuleScopeContext $scope){return $scope->name;}));
...
<?php  Capsule::PartialRender ('App', ['titlef' => "My App Title Here", 'data' => $scope->users], Capsule::CreateElement ('h1', [], 'Hello, App is working...')); ?>
