...
<?php  Capsule::PartialRender ('fragment', [], Capsule::CreateElement ('Center', [], 'Hello, Mann..!'), Capsule::CreateElement ('img', ['width' => 300, 'src' => $scope->myPhoto]), Capsule::CreateElement ('ul', [], function ($args, CapsuleScopeContext $scope) {for ( $i = 0; $i < count (is_array ($scope->users) ? $scope->users : []); $i++ ) {
 ...
 Capsule::PartialRender ('li', [], Capsule::CreateElement ('strong', [], 'Name =>'), function($args, CapsuleScopeContext $scope){return $scope->user->name;});

} }), Capsule::CreateElement ('br', []), 'Ysare inc.', Capsule::CreateElement ('h1', [], function($args, CapsuleScopeContext $scope){return $this->testName;}), Capsule::CreateElement ('br', []), function($args, CapsuleScopeContext $scope){return $this->someNames;}, Capsule::CreateElement ('img', ['src' => $scope->iconPlanTurbo]), Capsule::CreateElement ('br', []), Capsule::CreateElement ('img', ['src' => $scope->tomcat]), Capsule::CreateElement ('ul', [], function ($args, CapsuleScopeContext $scope) {for ( $i = 0; $i < count (is_array ($scope->myData['users']) ? $scope->myData['users'] : []); $i++ ) {
 ...
 Capsule::PartialRender ('li', [], function($args, CapsuleScopeContext $scope){return $scope->user->name;});
        ...
        'users',
        'mundo'
      ]], 'Hello, World..!'), Capsule::CreateElement ('br', []), Capsule::CreateElement ('span', ['style' => $scope->styles['paragraph']], 'I am Sam, and I am on ils -> name'), Capsule::CreateElement ('h3', [], 'foto => ', function($args, CapsuleScopeContext $scope){return $scope->logo;}), Capsule::CreateElement ('h1', ['style' => $scope->styles['text']], 'Image 2'), Capsule::CreateElement ('img', ['style' => $scope->styles['image'], 'width' => 200, 'src' => $scope->logo])); ?>
<?php }); ?>
