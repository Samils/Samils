...
?>
<?php  Capsule::PartialRender ('Fragment', [], Capsule::CreateElement ('Form', ['name' => 5], Capsule::CreateElement ('Mundo', [])), Capsule::CreateElement ('h1', [], 'Footer')); ?>
<?php }); ?>
...
<?php Capsule::Def ('Test3', function ($args, CapsuleScopeContext $scope) {
$scope->props = !isset ($args['props']) ? null : $args [ 'props' ];
?>
<?php  Capsule::PartialRender ('MaterialApp', [], Capsule::CreateElement ('CreateUser', ['props' => $scope->props])); ?>
<?php }); ?>
<?php Capsule::Export ('Test3'); ?>

<?php $module->exports = Capsule::Element ('Test3'); ?><?php if (!(is_object ($module->exports) && $module->exports instanceof Capsule)) { $module->exports = Capsule::Create (function () {}); }?>